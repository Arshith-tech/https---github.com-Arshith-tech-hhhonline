...
// Import Jost font using next/font/google (Next.js 13+)
...
const AboutHHH = () => {
  return (
    <section className={`${jost.className} relative py-20 bg-white overflow-hidden`}>
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed" style={{ fontFamily: "'Jost', sans-serif" }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              className="space-y-6"
            >
              <h3 className="text-3xl font-bold text-gray-900" style={{ fontFamily: "'Jost', sans-serif" }}>
                Our Mission
              </h3>

              <p className="text-lg text-gray-700 leading-relaxed" style={{ fontFamily: "'Jost', sans-serif" }}>
              ...
              <div className="text-center">
                ...
                <div className="text-3xl font-bold text-gray-900" style={{ fontFamily: "'Jost', sans-serif" }}>
                  5+
                </div>
                <div className="text-base text-gray-700 mt-1" style={{ fontFamily: "'Jost', sans-serif" }}>
            ...
            >
              ...
              >
                <p className="text-gray-800 italic mb-2" style={{ fontFamily: "'Jost', sans-serif" }}>
                  "We don't just change lives - we change entire communities, one act of kindness at a time."
                </p>
                <p className="text-sm text-gray-600" style={{ fontFamily: "'Jost', sans-serif" }}>— Sarah Johnson, Founder</p>
              </motion.div>
            </motion.div>
          </div>
        </div>
